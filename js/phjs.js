...
window.onload=function ()
{
	...
	for(var i=1; i<=iImgCount+1; i++)
	{
		...
		oNewImg.src='../360商品/images/z3d/small/image '+i+'.png';
	}
	...
	function onLoad()
	{
		...
		oSmallPhoto.onmouseover=function(ev)
		{
			...
			oSmallPhoto.onmousemove=function(ev)
			{
				...
				oImg.src='../360商品/images/z3d/small/image '+iNow+'.png';
				var newNow=0;
				...
				oImg.setAttribute('_src', '../360商品/images/z3d/small/image '+iNow+'.png');
		...
		function bigPhoto()
		{
			...
			oBox360a.onclick=function()
			{
				...
				oImgBig.src='../360商品/images/t.gif';
			}
		}
